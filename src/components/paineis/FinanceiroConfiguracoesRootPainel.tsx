 ...
 * configuração — Propina / Mensalidade e Taxa de Matrícula, cada uma agora
 * é a sua própria página (não mais uma subtela) — e o "Início de cobrança"
 * (que antes era um card aqui) passou a viver só dentro de Propina /
 * Mensalidade, já que só faz sentido para mensalidade.
 *
      ...
      <div className="space-y-6">
        <ManualDeFuncionamento>
          <ul className="list-disc space-y-2 pl-5 text-sm text-gray-600 dark:text-gray-300">
            <li>Aqui você define quanto cobrar de <b>Propina / Mensalidade</b> e de <b>Taxa de Matrícula</b>, por nível de ensino e, quando aplicável, por curso e ano.</li>
        ...
        <SubtelasMenu
          opcoes={[
            { id: "mensalidade", icon: "mdi:calendar-month-outline", label: "Propina / Mensalidade", descricao: "Definir o valor e os métodos aceites por ano/curso.", href: "/financas/configuracoes/mensalidade" },
